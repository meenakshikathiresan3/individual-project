...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        isFlexible = new QuestionNode("Does it provide the object creation mechanism that enhance the flexibilites of the existing code?");
        ...
        isNotifyGroup = new QuestionNode("Does it allow a group of objects to be notifed when some state changes?");
